...
namespace serialGeneratorGUI
{
    internal class Queries
    {
        ...
        public void dbCreate()
        {
            ...
            try
            {
                string qry = "INSERT INTO `serial`(`razon`, `active`) VALUES('" + rnd.Next(100000,10000000).ToString() + ",1);";
        ...
        public void dbUpdate(TextBox textbox1, TextBox textbox2)
        {
            try
            {
                string qry = "UPDATE `serial` SET `razon`='" + textbox1.Text + "',`active`=" + textbox2.Text + " " + " WHERE id=" + id;
